...
CREATE INDEX idx_room_notes_created_at ON room_notes(created_at DESC);
CREATE INDEX idx_room_notes_note_type ON room_notes(note_type);
...
-- Lettings users can read and create notes
